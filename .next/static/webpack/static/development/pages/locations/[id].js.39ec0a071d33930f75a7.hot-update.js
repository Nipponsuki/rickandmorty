...
/* harmony import */ var src_hooks_useInfiniteScrollWithoutPagination__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/hooks/useInfiniteScrollWithoutPagination */ "./hooks/useInfiniteScrollWithoutPagination.js");
...
var LocationDetails = function LocationDetails(_ref) {
  ...
  var _useInfiniteScroll = Object(src_hooks_useInfiniteScrollWithoutPagination__WEBPACK_IMPORTED_MODULE_9__["useInfiniteScroll"])(data && data.location.residents.length),
      count = _useInfiniteScroll.count;

  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, loading && __jsx(_Loader__WEBPACK_IMPORTED_MODULE_11__["default"], {
    __source: {
  ...
  }), count !== data.location.residents.length && __jsx(_Loader__WEBPACK_IMPORTED_MODULE_11__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70
    },
...
/*!**********************************************!*\
  !*** ./components/LocationDetails/styles.js ***!
  \**********************************************/
/*! exports provided: DetailsImage, ResidentsContainer, LocationDetailsContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DetailsImage", function() { return DetailsImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResidentsContainer", function() { return ResidentsContainer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocationDetailsContainer", function() { return LocationDetailsContainer; });
...
})(["width:100%;height:414px;@media (min-width:768px){width:396px;}img{width:100%;height:100%;object-fit:cover;margin:0 auto;}"]);
var ResidentsContainer = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__ResidentsContainer",
  componentId: "sc-1n3ebnd-1"
})(["display:flex;flex-direction:column;align-items:flex-start;"]);
var LocationDetailsContainer = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__LocationDetailsContainer",
  componentId: "sc-1n3ebnd-2"
...
//# sourceMappingURL=[id].js.39ec0a071d33930f75a7.hot-update.js.map